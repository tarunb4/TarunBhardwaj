...
const Hero = () => {
  ...
  return (
    <section className="h-screen bg-white overflow-x-hidden">
      <div className="px-8 lg:px-32 flex flex-col justify-center items-start h-full">
        <h1 className="text-4xl sm:text-5xl md:text-6xl mt-16 sm:mt-24 md:mt-32 font-bold tracking-wide">
          Hi, my name is  
        ...
        <h1 className="text-xl sm:text-2xl md:text-3xl font-semibold tracking-wide mt-4">
          {hero.subtitle}
        </h1>
        <a
          href="#About"
